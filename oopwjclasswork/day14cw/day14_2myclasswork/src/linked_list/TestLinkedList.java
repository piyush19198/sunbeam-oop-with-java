...
public class TestLinkedList {
	...
	public static void main(String[] args) {
		...
		l1.clear();//removes all elements from the list : empty 
	//	System.out.println("last elem "+l1.removeLast());
		System.out.println("last elem "+l1.pollLast());//null
